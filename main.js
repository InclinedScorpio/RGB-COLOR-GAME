...
var decidecolor=document.querySelector("#decideid");
decidecolor.textContent=colorselected;
var h4=document.querySelector("#h4");
var h2=document.querySelector("h2");
var decider=document.querySelector("#decider");

decider.addEventListener("click",deciderfun); // TO Change Colors.....
	
function deciderfun()
{
	if(decider.textContent==="Play Again?")
	{
		decider.textContent="Change Color";
	}
h4.textContent="";
...
function checksame()
{
	...
	if(mycolor===colorselected)
	{
		...
		decider.textContent="Play Again?"
	    }
	}
	else{
			lost++;
